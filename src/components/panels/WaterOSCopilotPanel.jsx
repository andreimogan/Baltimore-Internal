...
const EVENT_METRICS = {
  'water-main-burst-downtown': {
    ...
    description: 'A 12-inch water main rupture was detected at a major downtown intersection (example scenario).'
  },
  'pressure-loss': {
...
export default function WaterOSCopilotPanel() {
  ...
  const hasUnreadIntelligence = false
  ...
  return (
    ...
    >
      ...
      >
        ...
        <div className="flex items-center gap-1 shrink-0">
          <button
            ...
            onMouseEnter={(e) => { e.currentTarget.style.backgroundColor = 'var(--ui-border)'; e.currentTarget.style.color = 'var(--ui-text-primary)' }}
            onMouseLeave={(e) => { e.currentTarget.style.backgroundColor = 'transparent'; e.currentTarget.style.color = 'var(--ui-text-secondary)' }}
          >
      ...
      >
        <svg className="w-3 h-3" style={{ color: 'var(--ui-text-muted)' }} viewBox="0 0 10 10" fill="currentColor">
      ...
      <div className="flex" style={{ borderBottom: '1px solid var(--ui-border)' }}>
        <button
          ...
          style={{
            ...
            color: activeTab === 'chat' ? 'var(--ui-accent)' : 'var(--ui-text-muted)',
            borderBottom: activeTab === 'chat' ? '2px solid var(--ui-accent)' : '2px solid transparent',
          }}
        >
        ...
        {activeTab === 'chat' ? (
            ...
            <div className="flex-1 overflow-y-auto px-3 py-2 space-y-3">
              {chatMessages.length === 0 ? (
                ...
                <div className="flex flex-col items-center justify-center h-full text-center">
                  <MessageSquare className="w-12 h-12 mb-3" style={{ color: 'var(--ui-border)' }} />
                  <p className="font-semibold" style={{ fontSize: 'var(--text-sm)', color: 'var(--ui-text-secondary)' }}>
                    No conversations yet
                  </p>
                  <p className="mt-1" style={{ fontSize: 'var(--text-xs)', color: 'var(--ui-text-muted)' }}>
                    ...
                    <div key={message.id}>
                      {message.type === 'user-message' ? (
                        ...
                        <div className="flex items-start gap-2 mb-3">
                          ...
                          >
                            <p style={{ fontSize: 'var(--text-sm)', color: 'var(--ui-text-secondary)', lineHeight: '1.5', whiteSpace: 'pre-wrap' }}>
                              {message.message}
                            </p>
                          </div>
                        </div>
                        ...
                        <div className="flex items-start gap-2 mb-3">
                          ...
                          <div
                            className="flex-1 rounded-lg px-3 py-2"
                            style={{
                              backgroundColor: 'var(--ui-status-info-bg)',
                              borderLeft: '2px solid var(--ui-accent)',
                            }}
                          >
                            <p style={{ fontSize: 'var(--text-sm)', color: 'var(--ui-text-secondary)', lineHeight: '1.5' }}>
                              {message.message}
                            </p>
                          </div>
                        </div>
                        ...
                        (() => {
                          ...
                          return (
                            ...
                            >
                              <div className="px-3 py-2" style={{ borderBottom: '1px solid var(--ui-border)' }}>
                                <div className="flex items-center justify-between gap-2 mb-2">
                                  <div className="flex items-center gap-2 min-w-0">
                                    ...
                                    <span className="truncate" style={{ fontSize: 'var(--text-xs)', color: 'var(--ui-text-muted)' }}>
                                      {item.category || eventMetrics.category}
                                    </span>
                                  </div>
                                </div>
                                <h2 className="text-sm font-semibold leading-tight truncate mb-1" style={{ color: 'var(--ui-text-primary)' }}>
                                  {item.eventName}
                                </h2>
                                <p style={{ fontSize: 'var(--text-xs)', color: 'var(--ui-text-muted)', lineHeight: 1.4 }}>
                                  {item.description || eventMetrics.description}
                                </p>
                              </div>
                              <div className="px-3 py-2" style={{ borderBottom: '1px solid var(--ui-border)' }}>
                                <label className="block mb-1.5" style={{ fontSize: 'var(--text-xs)', fontWeight: 'var(--font-weight-medium)', color: 'var(--ui-text-muted)' }}>
                                  Burst Location
                                </label>
                                <div
                                  className="rounded-lg flex items-center justify-center"
                                  style={{ height: '80px', border: '1px solid var(--ui-border)', backgroundColor: 'var(--ui-surface-muted)' }}
                                >
                                  <span style={{ fontSize: 'var(--text-xs)', color: 'var(--ui-text-muted)' }}>Location data unavailable</span>
                                </div>
                              </div>
                              <div className="px-3 py-2 pt-2.5" style={{ borderBottom: '1px solid var(--ui-border)' }}>
                                <div className="flex items-center gap-1.5 font-semibold mb-1.5" style={{ fontSize: 'var(--text-xs)', color: 'var(--ui-accent)' }}>
                                  <Users className="w-3.5 h-3.5" aria-hidden="true" />
                                  Impact Metrics
                                </div>
                                <div className="grid grid-cols-2 gap-3">
                                  <div className="rounded p-2" style={{ backgroundColor: 'var(--ui-surface-muted)' }}>
                                    <p className="mb-1" style={{ fontSize: 'var(--text-xs)', fontWeight: 'var(--font-weight-medium)', color: 'var(--ui-text-muted)' }}>Customers Affected</p>
                                  ...
                                  <div className="rounded p-2" style={{ backgroundColor: 'var(--ui-surface-muted)' }}>
                                    <p className="mb-1" style={{ fontSize: 'var(--text-xs)', fontWeight: 'var(--font-weight-medium)', color: 'var(--ui-text-muted)' }}>Water Loss Rate</p>
                                    <p className="font-semibold" style={{ fontSize: 'var(--text-sm)', color: 'var(--color-red-400)' }}>{eventMetrics.waterLossRate}</p>
                                  </div>
                                  <div className="rounded p-2" style={{ backgroundColor: 'var(--ui-surface-muted)' }}>
                                    <p className="mb-1" style={{ fontSize: 'var(--text-xs)', fontWeight: 'var(--font-weight-medium)', color: 'var(--ui-text-muted)' }}>System Pressure</p>
                                    <p className="font-semibold" style={{ fontSize: 'var(--text-sm)', color: 'var(--color-red-400)' }}>{eventMetrics.systemPressure}</p>
                                  </div>
                                  <div className="rounded p-2" style={{ backgroundColor: 'var(--ui-surface-muted)' }}>
                                    <p className="mb-1" style={{ fontSize: 'var(--text-xs)', fontWeight: 'var(--font-weight-medium)', color: 'var(--ui-text-muted)' }}>Estimated Repair Time</p>
                              ...
                              {item.contexts?.[0]?.recommendation && (
                                <div className="px-3 py-2 pt-2.5">
                                  ...
                                  <div className="font-medium" style={{ fontSize: 'var(--text-sm)', color: 'var(--ui-text-primary)' }}>
                                    {item.contexts[0].recommendation.title}
                                  </div>
                                  <p className="mt-0.5" style={{ fontSize: 'var(--text-xs)', color: 'var(--ui-text-muted)' }}>
                            ...
                            {item.contexts?.[0]?.recommendation && viewOptimizedStates[item.id] && (
                              <>
                                ...
                                >
                                  <div className="px-3 py-2 pt-2.5">
                                    <div className="flex items-center justify-between gap-2 mb-2">
                                      <div className="flex items-center gap-1.5 font-semibold" style={{ fontSize: 'var(--text-xs)', color: 'var(--ui-accent)' }}>
                                      ...
                                      <button
                                        ...
                                        onMouseEnter={(e) => {
                                          e.currentTarget.style.backgroundColor = 'var(--ui-text-muted)'
                                          e.currentTarget.style.color = 'var(--ui-text-primary)'
                                        }}
                                        onMouseLeave={(e) => {
                                          e.currentTarget.style.backgroundColor = 'var(--ui-border)'
                                        ...
                                        <div className="grid grid-cols-2 gap-3">
                                          <div className="rounded p-2" style={{ backgroundColor: 'var(--ui-surface-muted)' }}>
                                            ...
                                            <div className="flex items-baseline gap-1.5">
                                              <span className="font-semibold" style={{ fontSize: 'var(--text-sm)', color: 'var(--ui-text-primary)' }}>{optimizedMetrics.customersAffected?.toLocaleString()}</span>
                                          ...
                                          <div className="rounded p-2" style={{ backgroundColor: 'var(--ui-surface-muted)' }}>
                                            <p className="mb-1" style={{ fontSize: 'var(--text-xs)', fontWeight: 'var(--font-weight-medium)', color: 'var(--ui-text-muted)' }}>Water Loss Rate</p>
                                            <div className="flex items-baseline gap-1.5">
                                              <span className="font-semibold" style={{ fontSize: 'var(--text-sm)', color: 'var(--ui-text-primary)' }}>{optimizedMetrics.waterLossRate}</span>
                                          ...
                                          <div className="rounded p-2" style={{ backgroundColor: 'var(--ui-surface-muted)' }}>
                                            <p className="mb-1" style={{ fontSize: 'var(--text-xs)', fontWeight: 'var(--font-weight-medium)', color: 'var(--ui-text-muted)' }}>System Pressure</p>
                                            <div className="flex items-baseline gap-1.5">
                                              <span className="font-semibold" style={{ fontSize: 'var(--text-sm)', color: 'var(--ui-text-primary)' }}>{optimizedMetrics.systemPressure}</span>
                                          ...
                                          <div className="rounded p-2" style={{ backgroundColor: 'var(--ui-surface-muted)' }}>
                                            <p className="mb-1" style={{ fontSize: 'var(--text-xs)', fontWeight: 'var(--font-weight-medium)', color: 'var(--ui-text-muted)' }}>Estimated Repair Time</p>
                                            <div className="flex items-baseline gap-1.5">
                                              <span className="font-semibold" style={{ fontSize: 'var(--text-sm)', color: 'var(--ui-text-primary)' }}>{optimizedMetrics.repairTime}</span>
                                    ...
                                    <div className="inline-ai-message-content">
                                      {implementationStates[item.id] === 'in-progress' && (
                                        <>
                                          ...
                                          <div style={{ display: 'flex', flexDirection: 'column', gap: '6px', fontSize: '10px', color: 'var(--ui-text-secondary)' }}>
                                      ...
                                      {implementationStates[item.id] === 'complete' && (
                                        <div>
                                          ...
                                          <p style={{ fontSize: '11px', color: 'var(--ui-text-secondary)', lineHeight: '1.5' }}>
                        ...
                        >
                          <div className="flex items-start justify-between gap-2 mb-2">
                            <div>
                              <p className="text-xs font-semibold uppercase tracking-wide" style={{ color: 'var(--ui-accent-muted)' }}>
                                AI Enhanced Recommended Action
                              </p>
                              <p className="text-sm font-semibold mt-0.5" style={{ color: 'var(--ui-text-primary)' }}>
                          ...
                          <p className="text-xs mb-3" style={{ color: 'var(--ui-text-secondary)', lineHeight: 1.5 }}>
                                ...
                                >
                                  ...
                                  {!message.approvedAction && (
                                    <button
                                      ...
                                      style={{ borderColor: 'var(--ui-text-muted)', color: 'var(--ui-text-muted)' }}
                                    >
                                      Remove
                                    </button>
                                  )}
                          ...
                          {!message.approvedAction && (
                            <div className="flex items-center gap-2 mb-3">
                              ...
                              <button
                                ...
                                style={{ borderColor: 'var(--ui-text-muted)', color: 'var(--ui-text-secondary)' }}
                              >
                                Add
                              </button>
                            </div>
                      ...
                      <div className="space-y-3">
                        ...
                        >
                          <div className="flex items-center justify-between mb-2">
                            <div className="flex items-center gap-2">
                              ...
                              <span className="font-semibold" style={{ fontSize: 'var(--text-sm)', color: 'var(--ui-text-primary)' }}>
                          ...
                          <div className="space-y-1.5 ml-8">
                            ...
                            {message.context.source === 'Network Meter Details' && (
                              <div className="mb-2 -ml-8 p-2 rounded" style={{ 
                                ...
                                <div style={{ fontSize: '10px', color: 'var(--ui-text-secondary)', lineHeight: '1.4' }}>
                                  {message.context.description}
                                </div>
                              </div>
                            )}
                            ...
                            <div className="flex justify-between">
                              <span style={{ fontSize: 'var(--text-xs)', color: 'var(--ui-text-muted)' }}>Event:</span>
                              <span className="font-medium text-right" style={{ fontSize: 'var(--text-xs)', color: 'var(--ui-text-secondary)' }}>
                                {message.context.eventName}
                              </span>
                            </div>
                            <div className="flex justify-between">
                              <span style={{ fontSize: 'var(--text-xs)', color: 'var(--ui-text-muted)' }}>Date:</span>
                              <span className="font-medium text-right" style={{ fontSize: 'var(--text-xs)', color: 'var(--ui-text-secondary)' }}>
                                {message.context.dateTimeRange}
                              </span>
                            </div>
                            <div className="flex justify-between">
                              <span style={{ fontSize: 'var(--text-xs)', color: 'var(--ui-text-muted)' }}>Affected Pipes:</span>
                              <span className="font-medium" style={{ fontSize: 'var(--text-xs)', color: 'var(--ui-text-secondary)' }}>
                            ...
                            <div className="flex justify-between">
                              <span style={{ fontSize: 'var(--text-xs)', color: 'var(--ui-text-muted)' }}>Customers:</span>
                              <span className="font-medium" style={{ fontSize: 'var(--text-xs)', color: 'var(--ui-text-secondary)' }}>
                            ...
                            <div className="flex justify-between items-start">
                              <span style={{ fontSize: 'var(--text-xs)', color: 'var(--ui-text-muted)' }}>Severity:</span>
                            ...
                            {message.context.source === 'Network Meter Details' && (
                              <>
                                <div className="flex justify-between">
                                  <span style={{ fontSize: 'var(--text-xs)', color: 'var(--ui-text-muted)' }}>Pressure:</span>
                                ...
                                <div className="flex justify-between">
                                  <span style={{ fontSize: 'var(--text-xs)', color: 'var(--ui-text-muted)' }}>Flow Rate:</span>
                                  <span className="font-medium" style={{ 
                                    fontSize: 'var(--text-xs)', 
                                    color: message.context.status === 'critical' ? 'var(--color-red-400)' : 
                                           'var(--ui-text-secondary)'
                                ...
                                <div className="flex justify-between">
                                  <span style={{ fontSize: 'var(--text-xs)', color: 'var(--ui-text-muted)' }}>Water Quality:</span>
                                  <span className="font-medium" style={{ fontSize: 'var(--text-xs)', color: 'var(--ui-text-secondary)' }}>
                                    {message.context.quality}
                                  </span>
                                </div>
                                <div className="flex justify-between">
                                  <span style={{ fontSize: 'var(--text-xs)', color: 'var(--ui-text-muted)' }}>Impact Level:</span>
                                  <span 
                                ...
                                <div className="flex justify-between">
                                  <span style={{ fontSize: 'var(--text-xs)', color: 'var(--ui-text-muted)' }}>Last Reading:</span>
                                  <span className="font-medium" style={{ fontSize: 'var(--text-xs)', color: 'var(--ui-text-secondary)' }}>
                        ...
                        {message.id === eventContextMessages[eventContextMessages.length - 1]?.id && (
                          <div className="space-y-2">
                            <p className="font-medium" style={{ fontSize: 'var(--text-sm)', color: 'var(--ui-text-primary)' }}>
                              ...
                              {actionPrompts.map(({ id, label, icon: Icon }) => (
                                <button
                                  ...
                                  onMouseEnter={(e) => {
                                    ...
                                    e.currentTarget.style.backgroundColor = 'var(--ui-accent)'
                            ...
                            <>
                              ...
                              >
                                <div className="px-3 py-2" style={{ borderBottom: '1px solid var(--ui-border)' }}>
                                  ...
                                  <div className="space-y-2 mt-2" style={{ fontSize: 'var(--text-xs)', color: 'var(--ui-text-secondary)', lineHeight: '1.5' }}>
                                    {message.context.status === 'critical' ? (
                                      <>
                                        <div className="flex gap-2">
                                          <span style={{ color: 'var(--ui-accent)', fontWeight: 'var(--font-weight-semibold)' }}>1.</span>
                                          <span>Dispatch a field crew to inspect the pipeline segment for signs of burst or leak</span>
                                        </div>
                                        <div className="flex gap-2">
                                          <span style={{ color: 'var(--ui-accent)', fontWeight: 'var(--font-weight-semibold)' }}>2.</span>
                                          <span>Isolate the affected zone if pressure continues to drop</span>
                                        </div>
                                        <div className="flex gap-2">
                                          <span style={{ color: 'var(--ui-accent)', fontWeight: 'var(--font-weight-semibold)' }}>3.</span>
                                          <span>Monitor flow and pressure at downstream meters for cascade effects</span>
                                        </div>
                                        <div className="flex gap-2">
                                          <span style={{ color: 'var(--ui-accent)', fontWeight: 'var(--font-weight-semibold)' }}>4.</span>
                                ...
                                {/* Projected Impact */}
                                {!message.approvedAction && (
                                  <div className="px-3 py-2" style={{ backgroundColor: 'var(--ui-surface-muted)' }}>
                                    <div className="flex items-center gap-1.5 font-semibold mb-2" style={{ fontSize: 'var(--text-xs)', color: 'var(--ui-accent)' }}>
                                      <ChartColumn className="w-3.5 h-3.5" aria-hidden="true" />
                                      Projected Impact
                                    </div>
                                    <div className="grid grid-cols-2 gap-2">
                                      <div className="p-2 rounded" style={{ backgroundColor: 'var(--ui-status-info-bg)', border: '1px solid var(--ui-status-info-border)' }}>
                                        <div style={{ fontSize: '10px', color: 'var(--ui-text-muted)', marginBottom: '4px' }}>Risk Reduction</div>
                                      ...
                                      <div className="p-2 rounded" style={{ backgroundColor: 'var(--ui-status-info-bg)', border: '1px solid var(--ui-status-info-border)' }}>
                                        <div style={{ fontSize: '10px', color: 'var(--ui-text-muted)', marginBottom: '4px' }}>Response Time</div>
                                      ...
                                      <div className="p-2 rounded" style={{ backgroundColor: 'var(--ui-status-info-bg)', border: '1px solid var(--ui-status-info-border)' }}>
                                        <div style={{ fontSize: '10px', color: 'var(--ui-text-muted)', marginBottom: '4px' }}>Estimated Cost</div>
                                        <div className="font-semibold" style={{ fontSize: 'var(--text-sm)', color: 'var(--ui-text-secondary)' }}>
                                          {message.context.status === 'critical' ? '$2,400' : '$850'}
                                        </div>
                                      </div>
                                      <div className="p-2 rounded" style={{ backgroundColor: 'var(--ui-status-info-bg)', border: '1px solid var(--ui-status-info-border)' }}>
                                        <div style={{ fontSize: '10px', color: 'var(--ui-text-muted)', marginBottom: '4px' }}>Prevented Loss</div>
                                        <div className="flex items-baseline gap-1">
                                          <span className="font-semibold" style={{ fontSize: 'var(--text-sm)', color: 'var(--color-green-400)' }}>
                ...
                <>
                  ...
                  <div className="mb-3 flex items-center gap-2 px-1">
                    <span style={{ fontSize: 'var(--text-xs)', color: 'var(--ui-text-muted)' }}>
                    ...
                    {expandedCardId ? (
                          ...
                          >
                            ...
                            <div className="space-y-1.5 mt-2">
                              ...
                              {message.context.source === 'Network Meter Details' && (
                                <>
                                  <div className="flex justify-between">
                                    <span style={{ fontSize: 'var(--text-xs)', color: 'var(--ui-text-muted)' }}>Meter ID:</span>
                                    <span className="font-medium" style={{ fontSize: 'var(--text-xs)', color: 'var(--ui-text-secondary)' }}>
                                      {message.context.meterId}
                                    </span>
                                  </div>
                                  <div className="flex justify-between">
                                    <span style={{ fontSize: 'var(--text-xs)', color: 'var(--ui-text-muted)' }}>Status:</span>
                                    <span className="font-medium" style={{ fontSize: 'var(--text-xs)', color: 'var(--ui-text-secondary)' }}>
                                      {message.context.statusLabel}
                                    </span>
                                  </div>
                                  ...
                                  <div className="flex justify-between">
                                    <span style={{ fontSize: 'var(--text-xs)', color: 'var(--ui-text-muted)' }}>Flow:</span>
                                    <span className="font-medium" style={{ fontSize: 'var(--text-xs)', color: 'var(--ui-text-secondary)' }}>
                                      {message.context.flow} L/min
                                    </span>
                                  </div>
                                  <div className="flex justify-between">
                                    <span style={{ fontSize: 'var(--text-xs)', color: 'var(--ui-text-muted)' }}>Quality:</span>
                                    <span className="font-medium" style={{ fontSize: 'var(--text-xs)', color: 'var(--ui-text-secondary)' }}>
                                      {message.context.quality}
                                    </span>
                                  </div>
                                  <div className="flex justify-between">
                                    <span style={{ fontSize: 'var(--text-xs)', color: 'var(--ui-text-muted)' }}>Impact:</span>
                                    <span className="font-medium" style={{ fontSize: 'var(--text-xs)', color: 'var(--ui-text-secondary)' }}>
                                      {message.context.impact}
                                    </span>
                                  </div>
                              ...
                              <div className="mt-2 pt-2" style={{ borderTop: '1px solid var(--ui-border)' }}>
                                <span className="font-medium" style={{ fontSize: 'var(--text-xs)', color: 'var(--ui-text-secondary)' }}>
                                  {message.context.recommendation?.title || message.context.description || 'Recommendation'}:
                                </span>
                                <p className="mt-1" style={{ fontSize: '10px', color: 'var(--ui-text-muted)', lineHeight: '1.4' }}>
                            ...
                            >
                              ...
                              <div className="space-y-1 mt-1">
                                <div className="flex justify-between items-center">
                                  <span style={{ fontSize: '9px', color: 'var(--ui-text-muted)' }}>Pipes:</span>
                                  <span className="font-medium" style={{ fontSize: '9px', color: 'var(--ui-text-secondary)' }}>
                                    {message.context.affectedPipes}
                                  </span>
                                </div>
                                <div className="flex justify-between items-center">
                                  <span style={{ fontSize: '9px', color: 'var(--ui-text-muted)' }}>Cust:</span>
                                  <span className="font-medium" style={{ fontSize: '9px', color: 'var(--ui-text-secondary)' }}>
                      ...
                      eventContextMessages.map((message) => (
                        ...
                        >
                          ...
                          <div className="space-y-1.5 mt-2">
                            <div className="flex justify-between items-center">
                              <span style={{ fontSize: '10px', color: 'var(--ui-text-muted)' }}>Pipes:</span>
                              <span className="font-medium" style={{ fontSize: '10px', color: 'var(--ui-text-secondary)' }}>
                                {message.context.affectedPipes}
                              </span>
                            </div>
                            <div className="flex justify-between items-center">
                              <span style={{ fontSize: '10px', color: 'var(--ui-text-muted)' }}>Customers:</span>
                              <span className="font-medium" style={{ fontSize: '10px', color: 'var(--ui-text-secondary)' }}>
                                {message.context.customersAffected >= 1000 
                                  ? (message.context.customersAffected / 1000).toFixed(1) + 'K' 
                                  : message.context.customersAffected}
              ...
              {isAiResponding && (
                <div className="flex items-start gap-2 mb-3">
                  ...
                  <div className="flex items-center gap-1 px-3 py-2">
                    <span className="animate-pulse" style={{ fontSize: '18px', color: 'var(--ui-accent)' }}>●</span>
                    <span className="animate-pulse" style={{ fontSize: '18px', color: 'var(--ui-accent)', animationDelay: '0.2s' }}>●</span>
                    <span className="animate-pulse" style={{ fontSize: '18px', color: 'var(--ui-accent)', animationDelay: '0.4s' }}>●</span>
                  </div>
                </div>
              )}
          ...
          <div className="flex flex-col h-full px-3 py-2 overflow-y-auto">
            {intelligenceItems.length === 0 ? (
              /* Empty state */
              <div className="flex flex-col items-center justify-center h-full text-center">
                <Lightbulb className="w-12 h-12 mb-3" style={{ color: 'var(--ui-border)' }} />
                <p className="font-semibold" style={{ fontSize: 'var(--text-sm)', color: 'var(--ui-text-secondary)' }}>
                  ...
                  return (
                    ...
                    >
                      ...
                      <div className="px-3 py-2" style={{ borderBottom: '1px solid var(--ui-border)' }}>
                        <div className="flex items-center justify-between gap-2 mb-2">
                          ...
                          <button
                            ...
                            style={{ borderRadius: 'var(--radius-sm)', color: 'var(--ui-text-muted)' }}
                            title="Expand"
                      ...
                      >
                        ...
                        >
                          <div className="w-full h-full flex items-center justify-center" style={{ backgroundColor: 'var(--ui-surface-muted)' }}>
                            <span style={{ fontSize: 'var(--text-xs)', color: 'var(--ui-text-muted)' }}>Location data unavailable</span>
                          </div>
                        </div>
                      </div>
                      ...
                      >
                        <div className="flex items-center justify-between gap-2 mb-2">
                          <label className="block" style={{ fontSize: 'var(--text-xs)', fontWeight: 'var(--font-weight-medium)', color: 'var(--ui-text-muted)' }}>
                          ...
                          <div className="flex items-center justify-center py-4" style={{ backgroundColor: 'var(--ui-surface-muted)' }}>
                            <span style={{ fontSize: 'var(--text-xs)', color: 'var(--ui-text-muted)' }}>Chart data unavailable</span>
                          </div>
                      </div>

                      {/* Recommended Action - matches Event Affected Area */}
                      {item.contexts[0]?.recommendation && (
                        <div className="px-3 py-2" style={{ borderTop: '1px solid var(--ui-border)' }}>
                          <div className="flex items-center gap-1.5 font-semibold mb-1.5" style={{ fontSize: 'var(--text-xs)', color: 'var(--ui-accent)' }}>
                            <AlertTriangle className="w-3.5 h-3.5" aria-hidden="true" />
                            Recommended Action
                          </div>
                      ...
                      <div className="px-3 py-2 pt-2.5" style={{ borderTop: '1px solid var(--ui-border)' }}>
                        <div className="flex items-center gap-1.5 font-semibold mb-1.5" style={{ fontSize: 'var(--text-xs)', color: 'var(--ui-accent)' }}>
                          <Users className="w-3.5 h-3.5" aria-hidden="true" />
                          Impact Metrics
                        </div>
                        ...
                        <div className="grid grid-cols-2 gap-3">
                          <div className="rounded p-2" style={{ backgroundColor: 'var(--ui-surface-muted)' }}>
                            <p className="mb-1" style={{ fontSize: 'var(--text-xs)', fontWeight: 'var(--font-weight-medium)', color: 'var(--ui-text-muted)' }}>
                              Customers Affected
                            </p>
          ...
          <div className="flex flex-col h-full px-3 py-2 overflow-y-auto">
            <div className="flex items-center gap-2.5 mb-3">
              ...
              <div>
                <h3 className="text-sm font-semibold leading-tight" style={{ color: 'var(--ui-text-primary)' }}>
                  Sand Intelligence Assistant
                </h3>
                <p className="leading-tight" style={{ fontSize: '11px', color: 'var(--ui-text-muted)' }}>
            ...
            <div className="space-y-1.5">
              {questions.map(({ icon: Icon, text }, i) => (
                <button
                  ...
                  onMouseEnter={(e) => {
                    e.currentTarget.style.backgroundColor = 'var(--ui-border)'
                    e.currentTarget.style.borderColor = 'var(--ui-text-muted)'
                    e.currentTarget.style.color = 'var(--ui-text-primary)'
                  }}
                  onMouseLeave={(e) => {
                    e.currentTarget.style.backgroundColor = 'rgba(55, 65, 81, 0.6)'
                ...
                >
                  <span className="mt-0.5 shrink-0" style={{ color: 'var(--ui-accent)' }}>
            ...
            <p className="text-center mt-3" style={{ fontSize: '10px', color: 'var(--ui-text-muted)' }}>
      ...
      {/* Input area */}
      <div className="px-3 pb-3 pt-1" style={{ borderTop: '1px solid var(--ui-border)' }}>
        <div
          className="flex items-center gap-2 rounded-lg border px-3 py-2 transition-colors"
          style={{
            backgroundColor: 'var(--ui-border)',
            borderColor: isAiResponding ? 'var(--ui-accent)' : 'var(--ui-border)',
          }}
        >
          <textarea
            value={inputText}
          ...
          <button
            ...
            title="Send message"
            onMouseEnter={(e) => { if (!e.currentTarget.disabled) e.currentTarget.style.backgroundColor = 'var(--ui-status-info-bg)' }}
            onMouseLeave={(e) => { e.currentTarget.style.backgroundColor = 'transparent' }}
          >
            <Send className="w-3.5 h-3.5" aria-hidden="true" />
          </button>
        </div>
        <p className="text-center mt-1.5" style={{ fontSize: '10px', color: 'var(--ui-text-muted)' }}>
